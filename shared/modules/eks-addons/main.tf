...
#   }
#   # values = [
#   #   file("../shared/module/wordpress/config/mysqlvalues.yaml")  # Path to your custom values file #issue mysqlvalues.yaml must exist prior to apply
#   # ]
...
#   values = [
#     file("../shared/module/wordpress/config/phpmyadminvalues.yaml") # Path to your custom values file #issue mysqlvalues.yaml must exist prior to apply
#   ]
